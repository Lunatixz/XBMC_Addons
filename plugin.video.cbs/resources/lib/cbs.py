                ...
                for meta in metas:
                    if 'itemprop="%s"'%type in meta:
                        if type == "name" and 'Episode' in meta:
                            metaLST['episodeNumber'] = (int(filter(str.isdigit, str(meta.split('" itemprop="%s"'%type)[0])))  or 0)
                        elif type == "name" and 'Season' in meta:
                            metaLST['seasonNumber'] = (int(filter(str.isdigit, str(meta.split('" itemprop="%s"'%type)[0])))  or 0)
                        else:
